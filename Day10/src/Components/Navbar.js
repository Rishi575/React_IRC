...
const NavBar = () => {
    ...
    const Login = (e) => {
        ...
        else if(!emailRegex.test(data.email))
        {
            ...
            if(data.username=="Wanderer" && data.password==="123456")
            {
                ...
                {visible ? (
                    <div className="card-wrapper">
                        <div className="">
                            ...
                            <form className="auth-container  shadow" onSubmit={Login}>
                                ...
                                <input type="password" name="" id="confirmPassword" placeholder="Confirm Password" className="auth-input" ref={confirmPasswordInputRef} />
                                {error.confirmPassword === '' ? '' : <span className="error-comp">{error.confirmPassword}</span>}
